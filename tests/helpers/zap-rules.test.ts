import * as vivaRealRules from '../../src/helpers/zap-rules';
import { Immobile, PricingInfos } from '../../src/models';

describe('filterData', function () {
    it("Should fail on minimum rental price condition", async function () {
        ...
        const dataFiltered = vivaRealRules.filterZapData(dataMock);
        expect(dataFiltered.length).toEqual(0);
    })

    it("Should fail on usableAreas condition", async function () {
    ...
    it("Should fail on minimum sale price condition", async function () {
